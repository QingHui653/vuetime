            ...
            <div class="header-right">
                <el-col :span="10">
                    ...
                    <el-dropdown menu-align="start">
                        <span>
                            <el-badge :value="dialogs.length" class="item">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item  v-for="dialog in dialogs" :key="dialog.time" divided>
                                 <div class="pop-div">
                                        ...
                                        <span class="pop-time"> {{dialog.time}}</span>
                                 </div>
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                            ...
                            <el-dropdown-menu slot="dropdown" >
                                ...
                                <el-dropdown-item v-for="task in tasks" :key="task.id" divided>
                                    <div class="task-div">
                                        ...
                                        <span class="task-span task-content">{{task.content}}<br/>
                                        <span class="task-time">截止：{{task.overTime}}</span></span>
...
export default {
  data () {
    return {
      name: 'linxin',
      dialogs: [
            {header: 'static/images/b_header2.jpg', content: '我有一个Style样式需要您帮忙处理以下。', time: '3分钟前'},
            {header: 'static/images/b_header3.jpg', content: '中午一起吃个饭吧，我请客。', time: '15分钟前'},
            {header: 'static/images/b_header.jpg', content: '需要处理一下POP展示的白边样式。', time: '18分钟前'},
            {header: 'static/images/b_header2.jpg', content: '下午3点开需求会议，准时参加。', time: '24分钟前'},
